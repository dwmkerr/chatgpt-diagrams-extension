...
const saveOptions = async () => {
  ...
  const displayMode = (<HTMLSelectElement>document.getElementById('display_mode')).value;
  const likesColor = (<HTMLInputElement>document.getElementById('like')).checked;
...
const restoreOptions = async () => {
  ...
  (<HTMLSelectElement>document.getElementById('display_mode')).value = options.displayMode;
  (<HTMLInputElement>document.getElementById('like')).checked = true;//options.likesColor;
};

document.addEventListener('DOMContentLoaded', restoreOptions);
(<HTMLElement>document.getElementById('save')).addEventListener('click', saveOptions);
